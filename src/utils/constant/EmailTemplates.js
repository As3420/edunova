  ...
  html: (firstName, otp) => `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; background-color: #f9f9f9;">
      <div style="background-color: #ffffff; padding: 30px; border-radius: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.05);">
        ...
        <p style="font-size: 16px;">Your One Time Password (OTP) for Edunova is:</p>
        ...
        <p style="font-size: 16px; margin-top: 30px;">Best regards,<br><strong>Team Edunova</strong></p>
      </div>
...
exports.sendAutoReply = {
  subject: "Thank you for contacting Edunova",

  text: (fullName) =>
    `Hello ${fullName},\n\nThank you for reaching out to Edunova.\n\nWe’ve received your enquiry and our team will get back to you as soon as possible.\n\nIn the meantime, feel free to explore our courses or contact us if your enquiry is urgent.\n\nWarm regards,\nTeam Edunova`,

  html: (fullName) => `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; background-color: #f9f9f9;">
      <div style="background-color: #ffffff; padding: 30px; border-radius: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.05);">
        <h2 style="color: #1a73e8;">Hello ${fullName},</h2>
        <p style="font-size: 16px;">Thank you for contacting <strong>Edunova</strong>.</p>
        <p style="font-size: 16px;">We’ve received your enquiry and our team will get back to you as soon as possible.</p>
        <p style="font-size: 16px;">In the meantime, feel free to explore our courses or reach out to us again if it’s urgent.</p>
        <p style="font-size: 16px; margin-top: 30px;">Warm regards,<br><strong>Team Edunova</strong></p>
      </div>
      <p style="text-align: center; font-size: 12px; color: #888; margin-top: 20px;">
